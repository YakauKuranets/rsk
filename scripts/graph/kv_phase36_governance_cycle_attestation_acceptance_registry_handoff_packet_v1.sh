...
OUT_JSON=phase36_governance_cycle_attestation_acceptance_registry_handoff_packet_v1.json \
OUT_MD=phase36_governance_cycle_attestation_acceptance_registry_handoff_packet_v1.md
 do
...
if missing_inputs or parse_errors or missing_markers:
    status = 'cycle_attestation_acceptance_registry_handoff_blocked'
    reason = 'safe_registry_handoff_reference_missing_or_invalid'
    ...
    status = 'cycle_attestation_acceptance_registry_handoff_ready'
    reason = 'safe_registry_handoff_reference_ready'

cycle_attestation_acceptance_registry_handoff_status = {
    'status': status,
    'reason': reason,
...
cycle_attestation_acceptance_registry_handoff_scope = {
    ...
    'scope_ru': 'Передача зарегистрированного accepted handed-over archived attest-нутого steady-state governance cycle.',
...
cycle_attestation_acceptance_registry_handoff_summary = [
    ...
    'handoff preserves registry interpretation',
    'operator-visible registry handoff summary required',
    'no handoff summary may imply runtime readiness',
]

cycle_attestation_acceptance_registry_handoff_guardrails = [
    'no runtime activation',
    'no runtime execution',
    'no graph mutation',
    'no remediation',
    'no reinterpretation of registry handoff as operational approval',
...
cycle_attestation_acceptance_registry_handoff_traceability_rules = [
    ...
    'operator-visible registry handoff summaries required',
...
cycle_attestation_acceptance_registry_handoff_invariants = [
...
validation_rules = [
    'cycle_attestation_acceptance_registry_handoff_packet_has_required_sections',
    'all_required_markers_present',
    'cycle_attestation_acceptance_registry_handoff_summary_is_complete_and_consistent',
    'cycle_attestation_acceptance_registry_handoff_guardrails_are_complete_and_consistent',
    'cycle_attestation_acceptance_registry_handoff_traceability_rules_are_complete_and_consistent',
    'execution_related_flags_absent',
    'runtime_open_flags_absent',
    'cycle_attestation_acceptance_registry_handoff_packet_is_compatible_with_design_control_only_state',
]

rejection_rules = [
    'missing_required_sections',
    'missing_required_markers',
    'malformed_cycle_attestation_acceptance_registry_handoff_summary',
    'malformed_cycle_attestation_acceptance_registry_handoff_guardrails',
    'malformed_cycle_attestation_acceptance_registry_handoff_traceability_rules',
    'stale_acceptance_registry_handoff_refs',
...
recommended_next_phase_step = {
    'phase': 'phase36_28_governance_cycle_attestation_acceptance_registry_handoff_ack_packet_v1',
    'goal_ru': 'Подготовить подтверждение получения handoff как отдельный governance/reference-only пакет без открытия runtime.',
    'runtime_authorization_change': False,
}

marker = f"KV_PHASE36_GOVERNANCE_CYCLE_ATTESTATION_ACCEPTANCE_REGISTRY_HANDOFF_PACKET_V1|status={status}|reason={reason}"

payload = {
    'version': 'phase36_governance_cycle_attestation_acceptance_registry_handoff_packet_v1',
    'generated_at': now,
    'status': status,
    'reason': reason,
    'marker': marker,
    'cycle_attestation_acceptance_registry_handoff_status': cycle_attestation_acceptance_registry_handoff_status,
    'cycle_attestation_acceptance_registry_handoff_scope': cycle_attestation_acceptance_registry_handoff_scope,
    'cycle_attestation_acceptance_registry_handoff_summary': cycle_attestation_acceptance_registry_handoff_summary,
    'cycle_attestation_acceptance_registry_handoff_guardrails': cycle_attestation_acceptance_registry_handoff_guardrails,
    'required_markers': required_markers,
    'cycle_attestation_acceptance_registry_handoff_traceability_rules': cycle_attestation_acceptance_registry_handoff_traceability_rules,
    'cycle_attestation_acceptance_registry_handoff_invariants': cycle_attestation_acceptance_registry_handoff_invariants,
