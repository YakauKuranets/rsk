...
OUT_JSON=phase36_governance_cycle_attestation_acceptance_registry_handoff_ack_archive_index_packet_v1.json \
OUT_MD=phase36_governance_cycle_attestation_acceptance_registry_handoff_ack_archive_index_packet_v1.md
 do
...
if missing_inputs or parse_errors or missing_markers:
    status = 'cycle_attestation_acceptance_registry_handoff_ack_archive_index_blocked'
    reason = 'safe_registry_handoff_ack_archive_index_reference_missing_or_invalid'
    ...
    status = 'cycle_attestation_acceptance_registry_handoff_ack_archive_index_ready'
    reason = 'safe_registry_handoff_ack_archive_index_reference_ready'

cycle_attestation_acceptance_registry_handoff_ack_archive_index_status = {
    'status': status,
    'reason': reason,
...
cycle_attestation_acceptance_registry_handoff_ack_archive_index_scope = {
...
cycle_attestation_acceptance_registry_handoff_ack_archive_index_summary = [
...
cycle_attestation_acceptance_registry_handoff_ack_archive_index_guardrails = [
...
cycle_attestation_acceptance_registry_handoff_ack_archive_index_traceability_rules = [
...
cycle_attestation_acceptance_registry_handoff_ack_archive_index_invariants = [
...
marker = f"KV_PHASE36_GOVERNANCE_CYCLE_ATTESTATION_ACCEPTANCE_REGISTRY_HANDOFF_ACK_ARCHIVE_INDEX_PACKET_V1|status={status}|reason={reason}"

payload = {
    'version': 'phase36_governance_cycle_attestation_acceptance_registry_handoff_ack_archive_index_packet_v1',
    'generated_at': now,
    'status': status,
    'reason': reason,
    'marker': marker,
    'cycle_attestation_acceptance_registry_handoff_ack_archive_index_status': cycle_attestation_acceptance_registry_handoff_ack_archive_index_status,
    'cycle_attestation_acceptance_registry_handoff_ack_archive_index_scope': cycle_attestation_acceptance_registry_handoff_ack_archive_index_scope,
    'cycle_attestation_acceptance_registry_handoff_ack_archive_index_summary': cycle_attestation_acceptance_registry_handoff_ack_archive_index_summary,
    'cycle_attestation_acceptance_registry_handoff_ack_archive_index_guardrails': cycle_attestation_acceptance_registry_handoff_ack_archive_index_guardrails,
    'required_markers': required_markers,
    'cycle_attestation_acceptance_registry_handoff_ack_archive_index_traceability_rules': cycle_attestation_acceptance_registry_handoff_ack_archive_index_traceability_rules,
    'cycle_attestation_acceptance_registry_handoff_ack_archive_index_invariants': cycle_attestation_acceptance_registry_handoff_ack_archive_index_invariants,
...
sections_obj = [
    ('Статус индексации архивированного подтверждения (`cycle_attestation_acceptance_registry_handoff_ack_archive_index_status`)', cycle_attestation_acceptance_registry_handoff_ack_archive_index_status),
    ('Область индексации архивированного подтверждения (`cycle_attestation_acceptance_registry_handoff_ack_archive_index_scope`)', cycle_attestation_acceptance_registry_handoff_ack_archive_index_scope),
...
sections_list = [
    ('Сводка индексации архивированного подтверждения (`cycle_attestation_acceptance_registry_handoff_ack_archive_index_summary`)', cycle_attestation_acceptance_registry_handoff_ack_archive_index_summary),
    ('Ограничители индексации архивированного подтверждения (`cycle_attestation_acceptance_registry_handoff_ack_archive_index_guardrails`)', cycle_attestation_acceptance_registry_handoff_ack_archive_index_guardrails),
    ('Правила трассируемости индексации архивированного подтверждения (`cycle_attestation_acceptance_registry_handoff_ack_archive_index_traceability_rules`)', cycle_attestation_acceptance_registry_handoff_ack_archive_index_traceability_rules),
    ('Инварианты индексации архивированного подтверждения (`cycle_attestation_acceptance_registry_handoff_ack_archive_index_invariants`)', cycle_attestation_acceptance_registry_handoff_ack_archive_index_invariants),
...
print('Готово: сформирован пакет индексации архивированного подтверждения передачи реестра acceptance registry в режиме только чтения и только дизайна.')
