...
OUT_JSON=phase36_governance_cycle_attestation_handover_packet_v1.json \
OUT_MD=phase36_governance_cycle_attestation_handover_packet_v1.md
 do
...
if missing_inputs or parse_errors or missing_markers:
    status = 'cycle_attestation_handover_blocked'
    reason = 'safe_cycle_attestation_handover_reference_missing'
    ...
    status = 'cycle_attestation_handover_ready'
    reason = 'safe_cycle_attestation_handover_reference_ready'

cycle_attestation_handover_status = {
    'status': status,
    'reason': reason,
...
cycle_attestation_handover_scope = {
...
cycle_attestation_handover_summary = [
...
cycle_attestation_handover_guardrails = [
...
cycle_attestation_handover_traceability_rules = [
...
cycle_attestation_handover_invariants = [
...
marker = f"KV_PHASE36_GOVERNANCE_CYCLE_ATTESTATION_HANDOVER_PACKET_V1|status={status}|reason={reason}"
payload = {
    'version': 'phase36_governance_cycle_attestation_handover_packet_v1',
    'generated_at': now,
    'status': status,
    'reason': reason,
    'marker': marker,
    'cycle_attestation_handover_status': cycle_attestation_handover_status,
    'cycle_attestation_handover_scope': cycle_attestation_handover_scope,
    'cycle_attestation_handover_summary': cycle_attestation_handover_summary,
    'cycle_attestation_handover_guardrails': cycle_attestation_handover_guardrails,
    'required_markers': required_markers,
    'cycle_attestation_handover_traceability_rules': cycle_attestation_handover_traceability_rules,
    'cycle_attestation_handover_invariants': cycle_attestation_handover_invariants,
...
for k, v in cycle_attestation_handover_status.items():
    md.append(f'- `{k}`: {v}')

for title, obj in [
    ('Область cycle attestation handover (`cycle_attestation_handover_scope`)', cycle_attestation_handover_scope),
...
for title, values in [
    ('Сводка cycle attestation handover (`cycle_attestation_handover_summary`)', cycle_attestation_handover_summary),
    ('Guardrails cycle attestation handover (`cycle_attestation_handover_guardrails`)', cycle_attestation_handover_guardrails),
    ('Правила traceability cycle attestation handover (`cycle_attestation_handover_traceability_rules`)', cycle_attestation_handover_traceability_rules),
    ('Инварианты cycle attestation handover (`cycle_attestation_handover_invariants`)', cycle_attestation_handover_invariants),
...
outm.write_text('\n'.join(md) + '\n', encoding='utf-8')
print('Готово: сформирован governance cycle attestation handover packet в режиме read-only/design-only.')
