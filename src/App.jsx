          ...
          {runtimeLogs.map((line, idx) => {
            ...
            return (
              <div key={`${idx}_${line}`} style={{
                ...
                lineHeight: '1.4',
                marginBottom: '2px',
                fontWeight: (isNexus || isSand) ? 'bold' : 'normal',
                borderLeft: isSand ? '2px solid #d4a843' : isNexus ? '2px solid #ffaa00' : 'none',
                paddingLeft: (isNexus || isSand) ? '6px' : '0',
