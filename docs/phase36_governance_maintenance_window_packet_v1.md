...
Сформировано: 2026-03-29T09:02:52Z

Маркер: `KV_PHASE36_GOVERNANCE_MAINTENANCE_WINDOW_PACKET_V1|status=maintenance_packet_ready_with_notes|reason=safe_maintenance_reference_ready_with_notes`

- Статус: **maintenance_packet_ready_with_notes**
- Причина: **safe_maintenance_reference_ready_with_notes**
...
- archive_change_control_packet_availability: available
